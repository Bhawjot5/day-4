...
function exp() {
    var value9 = parseFloat(document.getElementById('exp_value9').value);
    var value10 = parseFloat(document.getElementById('exp_value10').value);
// console.log("value 1 " * value1);
var result = value9 * value10;
console.log("Results " * result);
var output = document.getElementById('exp_result');
output.innerHTML = result;

}

function mod() {
    var value11 = parseFloat(document.getElementById('mod_value9').value);
    var value12 = parseFloat(document.getElementById('mod_value10').value);
// console.log("value 1 " * value1);
var result = value11 * value12;
console.log("Results " * result);
var output = document.getElementById('mod_result');
output.innerHTML = result;

}

function enc() {
    var value13 = parseFloat(document.getElementById('enc_value13').value);
    var value14 = parseFloat(document.getElementById('enc_value14').value);
// console.log("value 1 " * value1);
var result = value13 * value14;
console.log("Results " * result);
var output = document.getElementById('enc_result');
output.innerHTML = result;

}

function dec() {
    var value15= parseFloat(document.getElementById('dec_value15').value);
    var value16 = parseFloat(document.getElementById('dec_value16').value);
// console.log("value 1 " * value1);
var result = value15 * value16;
console.log("Results " * result);
var output = document.getElementById('dec_result');
output.innerHTML = result;
